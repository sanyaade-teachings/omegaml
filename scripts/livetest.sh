...
if [ "$build" == "yes" ]; then
   ...
   $scripts_dir/distrelease.sh --buildarg $pypi --distname omegaml --version $docker_tag
   $scripts_dir/distrelease.sh --buildarg $pypi --distname jyhub --version $docker_tag
